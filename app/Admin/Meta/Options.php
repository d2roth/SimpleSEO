...
class Options {
    ...
    public function __construct() {
		...
		$content .= '<a href="'.$adminUrl.'?action=sseo_create_sitemap" class="button button-primary" onClick="return confirm(\'Are you sure you want to create a new sitemap?\')">Create Sitemap</a>&nbsp;<a href="'.$adminUrl.'?action=sseo_delete_sitemap" class="button button-primary" onClick="return confirm(\'Are you sure you want to delete the current sitemap?\')">Delete Sitemap</a>';
		$content .= '</td>';
		$content .= '</tr>';
		$content .= '<tr>';
		$content .= '<th scope="row">'; 
		...
		$content .= '<a href="/wp-admin/admin-post.php?action=sseo_yoast_import" class="button button-primary" onclick="return confirm(';
		...
		$content .= '<a href="/wp-admin/admin-post.php?action=sseo_rankmath_import" class="button button-primary" onclick="return confirm(';
		...
		$content .= '<a href="/wp-admin/admin-post.php?action=sseo_allinone_import" class="button button-primary" onclick="return confirm(';
